...
function Home() {
  ...
  const settings = {
    ...
    autoplay: true,
    autoplaySpeed: 2500,
    arrows: true, // فعلنا أزرار السابق والتالي
    pauseOnHover: true,
    cssEase: "ease-in-out",
